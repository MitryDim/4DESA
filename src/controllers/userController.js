...
//       return res
//         .status(200)
//         .send({ message: "Account has already been verified" });
//     }
...
//       to: req.body.email,
//       subject: "Isee mail verification request",
//       html: emailConfig.getHtml(encodeURIComponent(user.token), user.username),
//     };
...
//       } else {
//         console.log(
//           "Verification email sent successfully. Server response:",
//           info.response
//         );
//         return res.send({
